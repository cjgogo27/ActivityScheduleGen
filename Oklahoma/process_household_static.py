...
trip_df = pd.read_csv(r'E:\FrankYcj\FinalTraj\Oklahoma\2017-tsdc-nhts-incog-add-on-download\data\survey_trip.csv', low_memory=False)
...
invalid_sampno_file = r'E:\FrankYcj\FinalTraj\Oklahoma\processed_data\invalid_sampno_from_person.json'
try:
...
invalid_sampno_trajectory_file = r'E:\FrankYcj\FinalTraj\Oklahoma\processed_data\invalid_sampno_from_trajectory.json'
try:
...
# 保存结果
output_file = r'E:\FrankYcj\FinalTraj\Oklahoma\processed_data\oklahoma_household_static.json'
print(f"\n正在保存到 {output_file}...")

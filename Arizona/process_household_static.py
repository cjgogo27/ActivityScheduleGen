...
# 读取数据
print("正在读取数据...")
household_df = pd.read_csv(r'E:\mayue\FinalTraj\Arizona\nhts-azdot-17\nhts-azdot-17 (1)\data\survey_household.csv', low_memory=False)
person_df = pd.read_csv(r'E:\mayue\FinalTraj\Arizona\nhts-azdot-17\nhts-azdot-17 (1)\data\survey_person.csv', low_memory=False)
trip_df = pd.read_csv(r'E:\mayue\FinalTraj\Arizona\nhts-azdot-17\nhts-azdot-17 (1)\data\survey_trip.csv', low_memory=False)
value_lookup_df = pd.read_excel(r'E:\mayue\FinalTraj\Arizona\nhts-azdot-17\nhts-azdot-17 (1)\data\Value_Lookup.xlsx')
...
invalid_sampno_file = r'E:\mayue\FinalTraj\Arizona\processed_data\invalid_sampno_from_person.json'
try:
...
invalid_sampno_trajectory_file = r'E:\mayue\FinalTraj\Arizona\processed_data\invalid_sampno_from_trajectory.json'
try:
...
# 保存结果
output_file = r'E:\mayue\FinalTraj\Arizona\processed_data\arizona_household_static.json'
print(f"\n正在保存到 {output_file}...")

...
# 保存需要移除的 sampno 列表
invalid_sampno_file = r'E:\mayue\FinalTraj\Arizona\processed_data\invalid_sampno_from_trajectory.json'
...
# 保存结果
output_file = r'E:\mayue\FinalTraj\Arizona\processed_data\arizona_trajectories_processed.json'
